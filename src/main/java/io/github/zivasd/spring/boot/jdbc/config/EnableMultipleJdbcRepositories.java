...
@Repeatable(EnableMultipleJdbcRepositoriesArray.class)
public @interface EnableMultipleJdbcRepositories {
    /**
    ...
    /**
     * Configures the name of the
     * {@link org.springframework.data.jdbc.core.convert.DataAccessStrategy} bean
     * definition to
     * be used to create repositories discovered through this annotation. Defaults
     * to {@code defaultDataAccessStrategy}.
     */
    String dataAccessStrategyRef() default "";

    /**
     * Configures the name of the {@link DataSourceTransactionManager} bean
     * definition to be used to create repositories
